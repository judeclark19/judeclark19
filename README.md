...
Hi, I'm Jude Clark, a frontend engineer based in Atlanta.

I build web applications with React, Next.js, and TypeScript, focusing on clean architecture and intuitive user experiences. This is where I share projects, experiments, and the things I'm currently building.
...
- 🔭 Projects
  - 🃏 [V-Cell](https://github.com/judeclark19/v-cell) — a modern twist on FreeCell
      - V-Cell 2 is currently under construction with a rebuilt game engine, robust keyboard navigation, improved drag-and-drop mechanics, and persistent game state.
